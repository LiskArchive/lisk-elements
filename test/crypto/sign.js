...
import { getKeys } from '../../src/crypto/keys';
...
describe('sign', () => {
	...
	const defaultSignature =
		'X9aY0zwAn8NY8ghfZkZa5QrDd00aXDbVFn+9f5usa2SLJrspdtNgtihv6hw2fdEo2tfwzCQaAwH7z/9Mp3ueCw==';
	const defaultSecondSignature =
		'nGWmc3+0RXyLFGX51ony9hfDn44Q4mhtA/vTiwkl7rnl13eYX6KEzKardnflUjnWG0Kbj9wfshKGsZuQRW5/Ag==';
	const defaultWrongSignature =
		'E2gerxJlGhgaPcY+Az90YL272HanGOE+za/DdEy011UvReN5V1UBBJXzuHhX3QoX2IhunJ2DRf+wvXBuZrz7Cw==';
	...
	describe('signTransaction and verify', () => {
		describe('#signTransaction', () => {
			...
			const expectedSignature =
				'05383e756598172785843f5f165a8bef3632d6a0f6b7a3429201f83e5d60a5b57faa1fa383c4f33bb85d5804848e5313aa7b0cf1058873bc8576d206bdb9c804';
			const transaction = {
				type: 0,
				amount: 1000,
		...
		describe('#verify', () => {
			...
			const signature =
				'e7027dbe9bb8ebcc1738c560fe0a09161d781d9bfc5df4e9b4ccba2d7a1febcd25ba663938c8d22d4902d37435be149cfb0fd69e7a59daf53469abe8f6509e0c';
			const signSignature =
				'e88b4bd56a80de3b15220bdf0d1df0aa024a7a127ef07b8dc36a4e12d50e8eb338bc61ebe510ab15839e23f073cffda2a8c8b3d1fc1f0db5eed114230ecffe0a';
			...
			beforeEach(() => {
				...
				transactionForVerifyTwoSignatures = Object.assign({}, transactionForVerifyOneSignature, {
					signSignature,
			...
			it('should throw if try to verify a second sign transaction without secondPublicKey', () => {
				verifyTransaction
					.bind(null, transactionForVerifyTwoSignatures)
	...
	describe('#multiSignTransaction', () => {
		it('should signTransaction a multisignature transaction', () => {
			const expectedMultiSignature =
				'9eb6ea53f0fd5079b956625a4f1c09e3638ab3378b0e7847cfcae9dde5a67121dfc49b5e51333296002d70166d0a93d2f4b5eef9eae4e040b83251644bb49409';
