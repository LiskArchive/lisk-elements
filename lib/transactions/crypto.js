...
function sign(transaction, keys) {
	...
	var signature = sodium.crypto_sign_detached(hash, new Buffer(keys.privateKey, "hex"));
...
function verify(transaction) {
	...
	var signatureBuffer = new Buffer(transaction.signature, "hex");
	var senderPublicKeyBuffer = new Buffer(transaction.senderPublicKey, "hex");
	var res = sodium.crypto_sign_verify_detached(signatureBuffer, hash, senderPublicKeyBuffer);
...
function verifySecondSignature(transaction, publicKey) {
	...
	var res = sodium.crypto_sign_verify_detached(signSignatureBuffer, hash, publicKeyBuffer);
